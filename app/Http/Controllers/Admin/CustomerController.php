...
class CustomerController extends Controller
{
    ...
    public function show(Customer $customer)
    {
        ...
        return view('backend.customers.view', compact('customer', 'orders', 'breadcrumbs', 'pageConfigs'));
    }
    ...
    public function edit(Customer $customer)
    {
        ...
        return view('backend.customers.profile', compact('customer', 'breadcrumbs', 'pageConfigs'));
    }
