...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        try {
            ...
            if ($customer && $request->filled('fcm_token')) {
    ...
    public function register(RegisterRequest $request)
    {
        ...
        $customerProfile->city_id = $request->city_id;
    ...
    public function updateProfile(ProfileRequest $request)
    {
        ...
        $profile->city_id = $request->has('city_id') ? $request->city_id : $profile->city_id;
    ...
    public function changePassword(ChangePasswordRequest $request)
    {
        ...
        return $this->successResponse(201, trans('api.auth.old_password_incorrect'), 201, null);
    }
    ...
    public function facebookLogin(Request $request)
    {
        ...
        if ($provider) {
            ...
            $profile->full_name = $facebook['fullName'];
            $profile->email = isset($facebook['email']) ? $facebook['email'] : null;
    ...
    public function googleLogin(Request $request)
    {
        ...
        if ($provider) {
            ...
            $profile = new CustomerProfile();
            $profile->customer_id = $customer->id;
            $profile->full_name = $google['fullName'];
            $profile->email = isset($google['email']) ? $google['email'] : null;
