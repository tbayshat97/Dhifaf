...
class Product extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if ($is_variant) {
            ...
            $data['product_max_price'] = (($this->is_variant && $this->group) ? $this->group->maxPrice() : $this->groupMemberMaxPrice());
            $data['product_min_price'] = (($this->is_variant && $this->group) ? $this->group->minPrice() : $this->groupMemberMinPrice());
        }
