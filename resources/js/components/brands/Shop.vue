        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-3">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/brands">{{ translate("layout.brands") }}</a>
                    </li>
...
export default {
    ...
    mounted() {
        ...
        axios
            .get(
                "/api/customer/product/brand/slug/" + this.$route.params.slug,
                {
                    headers
                }
            )
    ...
    methods: {
        getProducts: async function(samePage = false, loadMore = false) {
            ...
            await axios
                ...
                .then(response => {
                    // $.each(response.data.data.data, (key, value) => {
                    //     let exists = this.categories.find(
                    //         data =>
                    //             data.category_id ==
                    //             value.product_category[0].category_id
                    //     );
                    //     if (!exists) {
                    //         this.categories.push(value.product_category[0]);
                    //     }
                    //     let exists2 = this.sizes.find(
                    //         data => data.id == value.product_size.id
                    //     );
                    //     if (!exists2 && value.product_size) {
                    //         this.sizes.push(value.product_size);
                    //     }

                    //     let exists3 = this.colors.find(
                    //         data => data.product_color == value.product_color
                    //     );
                    //     if (!exists3 && value.product_color) {
                    //         this.colors.push(value.product_color);
                    //     }

                    //     this.brands.push(value.product_brand);
                    //     this.subBrands.push(value.product_sub_brand);
                    // });
