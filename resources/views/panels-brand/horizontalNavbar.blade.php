    ...
    <nav class="white hide-on-med-and-down" id="horizontal-nav">
        <div class="nav-wrapper">
            <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation">
                ...
                @if(!empty($menuDataBrand[1]) && isset($menuDataBrand[1]))
                @foreach ($menuDataBrand[1]->menu as $menu)
                @php
                $custom_classes="";
                if(isset($menu->class))
                {
                ...
                <li>
                    ...
                    @include('panels-brand.horizontalSubmenu',['menu' => $menu->submenu],['activate'=>$menu->activate])
                    @endif
                </li>
                @endforeach
                @endif
