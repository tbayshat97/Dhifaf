    ...
    <nav
        ...
        <div class="nav-wrapper">
                ...
                <li>
                    <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                        ...
                        <span class="avatar-status avatar-online">
                            @php
                            $accountImage = auth('brand')->user()->image ? asset('storage/'.auth('brand')->user()->image) :
            ...
            <ul class="dropdown-content" id="profile-dropdown">
                {{-- <li>
                    <a class="grey-text text-darken-1" href="{{ route('brand.profile') }}">
                ...
                <li>
                    <a class="grey-text text-darken-1" href="{{ route('brand.logout') }}">
