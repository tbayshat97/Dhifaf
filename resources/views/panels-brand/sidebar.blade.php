<aside
    ...
    <div class="brand-sidebar">
        <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="{{asset('/brand')}}">
    ...
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out"
        ...
        @if(!empty($menuDataBrand[0]) && isset($menuDataBrand[0]))
        @foreach ($menuDataBrand[0]->menu as $menu)
        ...
        <li class="bold {{(request()->is($menu->url.'*')) ? 'active' : '' }}">
            ...
            @include('panels-brand.submenu', ['menu' => $menu->submenu])
            @endif
        </li>
        @endif
        @endforeach
