...
<section class="tabs-vertical mt-1 section">
    <div class="row">
        ...
        <div class="col l8 s12">
            ...
            <div id="general">
                <div class="card-panel">
                    <form id="addform" class="formValidate0" method="POST" action="{{ route('brand.profile.update') }}"
                    ...
                    @csrf
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                ...
                                <input class="validate" disabled value="{{ $brand->username }}" type="text">
                            </div>
                            <div class="input-field col s12">
                                <label for="curl0">First name *</label>
                                <input type="text" value="{{ $brand->profile->first_name }}" class="validate"
                                    name="first_name">
                            </div>
                            <div class="input-field col s12">
                                <label for="curl0">Last name *</label>
                                <input type="text" value="{{ $brand->profile->last_name }}" class="validate"
                                    name="last_name">
                            </div>
                            <div class="input-field col s12">
                                <label for="curl0">Phone Number *</label>
                                <input type="tel" value="{{ $brand->profile->phone }}" class="validate"
                                    name="phone">
                            </div>
                            <div class="col s12">
                                ...
                                <div class="jFiler-input-dragDrop pos-relative">
                                    <div class="jFiler-input-inner">
                                        ...
                                        <div class="filediv">
                                            <input type="file" name="image" data-fileuploader-files="{{ getFileUploaderMedia($brand->profile->image) }}"
                                                class="file" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="jFiler-input-inner">
                                        ...
                                        <div class="filediv">
                                            <input type="file" name="gallery[]"
                                                data-fileuploader-files="{{ getFileUploaderMedia($brand->profile->gallery)}}" class="file" multiple="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <form id="addform" class="formValidate0" method="POST" action="{{ route('brand.profile.update') }}"
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input type="text" value="{{ $brand->profile->price_per_hour }}" class="validate"
                                    name="price_per_hour">
                            </div>
                            <div class="input-field col s12">
                                <textarea id="bio" name="bio"
                                    class="materialize-textarea">{{ $brand->profile->bio }}</textarea>
                                ...
                                <p>
                                    <label>
                                        <input class="validate" name="gender" type="radio" value="1"
                                            @if($brand->profile->gender && $brand->profile->gender ===
                            ...
                            <div class="input-field col s12">
                                <input type="text" name="birthdate" class="datepicker" id="dob" @if ($brand->profile
                                && $brand->profile->birthdate)
                                value="{{ $brand->profile->birthdate->format('d/m/Y') }}"
                                @endif>
                    ...
                    <form id="addform" class="formValidate0" method="POST" action="{{ route('brand.profile.update') }}"
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input type="text" id="facebook_link" value="{{ $brand->profile->facebook_link }}" class="validate"
                                    name="facebook_link">
                            </div>
                            <div class="input-field col s12">
                                <label for="twitter_link">Twitter Link</label>
                                <input type="text" id="twitter_link" value="{{ $brand->profile->twitter_link }}" class="validate"
                                    name="twitter_link">
                            </div>
                            <div class="input-field col s12">
                                <label for="linkedin_link">LinkedIn Link</label>
                                <input type="text" id="linkedin_link" value="{{ $brand->profile->linkedin_link }}" class="validate"
                                    name="linkedin_link">
                            </div>
                            <div class="col s12 display-flex justify-content-end form-action">
                                <button type="submit" class="btn indigo waves-effect waves-light mr-2">Save
