{{-- layout --}}
@extends('layouts-brand.fullLayoutMaster')
...
<div id="login-page" class="row">
    <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
        <form class="login-form" method="POST" action="{{ route('brand.login') }}">
            @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="input-field col s6 m6 l6">
                    <p class="margin right-align medium-small">
                        <a href="{{ route('brand.forget.password.get') }}">Forgot password?</a>
                    </p>
                </div>
            </div>
        </form>
