                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form id="addform" class="forms-sample" method="POST"
                            action="{{ route('brand.brand-slider.update', $brandSlider) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6 ">
                                    ...
                                    value="{{$brandSlider->translateOrDefault($lang['code'])->title}}"
                                ...
                                <div class="input-field col s12 m6 l6 ">
                                    ...
                                    value="{{$brandSlider->translateOrDefault($lang['code'])->content}}"
                                        class="validate" required />
                                ...
                                <div class="input-field col s12 m6 l6">
                                    ...
                                    value="{{$brandSlider->translateOrDefault($lang['code'])->btn_text}}"
                                        class="validate" required />
                                ...
                                <div class="input-field col s12">
                                    <input type="text" name="btn_link" id="btn_link"
                                        class="validate" value="{{ $brandSlider->btn_link }}" required />
                                ...
                                <div class="col s12">
                                    ...
                                    <div class="s12 input-field">
                                        <input type="file" name="image" id="input-file-events" class="dropify-event"
                                            data-default-file="{{ asset('storage') . '/' .$brandSlider->image }}"
                                            accept="image/*" />
                                    </div>
                                </div>
                                <div class="col s12">
                                    ...
                                    <div class="s12 input-field">
                                        <input type="file" name="logo" id="input-file-events" class="dropify-event"
                                            data-default-file="{{ asset('storage') . '/' .$brandSlider->logo }}"
                                            accept="image/*" />
                                    </div>
                                </div>
                                <div class="input-field col s12">
