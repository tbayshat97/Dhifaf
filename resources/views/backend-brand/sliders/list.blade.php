...
@section('content')
                                    ...
                                    <tbody>
                                        @foreach ($slider as $key => $item)
                                            ...
                                            <td class="center-align">
                                                <a href="{{ route('brand.brand-slider.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                <a href="#modalDelete" onclick="setRoute('{{ $item }}', '{{ route('brand.brand-slider.destroy', $item) }}')" class="modal-trigger btn-floating red pulse"><i class="material-icons">delete</i></a>
                                            </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div id="modalDelete" class="modal">
        <div class="modal-content">
            <h4>{{ __('admin-content.delete-banner') }}</h4>
            <p>{{ __('admin-content.are-you-sure-you-need-to-delete-this') }} {{ __('admin-content.banner') }}?</p>
        </div>
