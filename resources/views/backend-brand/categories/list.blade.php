                                    ...
                                    <tbody>
                                        @foreach ($categories as $item)
                                            ...
                                            <td class="center-align">
                                                <a href="{{ route('brand.brand-category.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                <a href="#modalDelete" onclick="setRoute('{{ $item }}', '{{ route('brand.brand-category.destroy', $item) }}')" class="modal-trigger btn-floating red pulse"><i class="material-icons">delete</i></a>
                                            </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
