            ...
            if (willDelete) {
                $.ajax({
                    ...
                    success: function (response) {
                        setTimeout(goTo("{{ route('brand.course.live.list') }}"), 2000);
                    }
                });
            } else {
