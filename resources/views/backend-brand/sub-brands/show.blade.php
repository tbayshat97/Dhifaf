                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form id="addform" class="forms-sample" method="POST"
                            action="{{ route('brand.sub-brand.update', $subBrand) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col s12">
                                    ...
                                    <div class="s12 input-field">
                                        <input type="file" name="header" id="input-file-events" class="dropify-event"
                                            data-default-file="{{ asset('storage') . '/' .$subBrand->header }}"
                                            accept="image/*" />
                                    </div>
                                </div>
                                <div class="col s12">
                                    ...
                                    <div class="s12 input-field">
                                        <div class="switch">
                                            <label>
                                                Inactive
                                                <input type="checkbox" name="is_active" id="is_active" @if($subBrand->is_active) checked @endif>
