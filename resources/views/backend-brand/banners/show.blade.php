                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form id="addform" class="forms-sample" method="POST"
                            action="{{ route('brand.brand-banner.update', $brand_Banner) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6 ">
                                    ...
                                    value="{{$brand_Banner->translateOrDefault($lang['code'])->name}}"
                                ...
                                <div class="col s12">
                                    ...
                                    <div class="s12 input-field">
                                        <input type="file" name="image" id="input-file-events" class="dropify-event"
                                            data-default-file="{{ asset('storage') . '/' .$brand_Banner->image }}"
                                            accept="image/*" />
                                    </div>
                                </div>
