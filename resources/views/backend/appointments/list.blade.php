                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="chip lighten-5 blue blue-text">
                                                        <a class="tooltipped" data-position="top"
                                                            data-delay="50" data-tooltip="Show profile"
                                                            href="{{route('admin.influencer.show', $item->influencer->id)}}"> {{ $item->influencer->profile->fullName }}
                                                        </a>
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td class="center-align">
                                                    <a href="{{ route('admin.appointment.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">visibility</i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                </tbody>
