            ...
            <div class="card">
                <div class="card-content invoice-print-area">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col m6 s12">
                            <div class="divider show-on-small hide-on-med-and-up mb-3"></div>
                            <h6 class="invoice-to">Influencer</h6>
                            <div class="invoice-address">
                                <span>Username: {{ $appointment->influencer->username }}</span>
                            </div>
                            <div class="invoice-address">
                                <span>Name: {{ $appointment->influencer->profile->first_name}}
                                    {{$appointment->influencer->profile->last_name }}</span>
                            </div>
                            <div class="invoice-address">
                                <span>Phone: {{$appointment->influencer->profile->phone}}</span>
                            </div>
                            <div class="invoice-address">
