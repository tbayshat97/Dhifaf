...
@section('content')
                                    ...
                                    <tbody>
                                        @foreach ($colors as $item)
                                            ...
                                            <td class="center-align">
                                                <a href="{{ route('admin.color.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                <a href="#modalDelete" onclick="setRoute('{{ $item }}', '{{ route('admin.color.destroy', $item) }}')" class="modal-trigger btn-floating red pulse"><i class="material-icons">delete</i></a>
                                            </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div id="modalDelete" class="modal">
        <div class="modal-content">
            <h4>{{ __('admin-content.delete-color') }}</h4>
            <p>{{ __('admin-content.are-you-sure-you-need-to-delete-this') }} {{ __('admin-content.color') }}?</p>
        </div>
