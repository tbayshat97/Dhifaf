                    ...
                    <div class="card-content">
                        ...
                        <div id="html-view-validations">
                            <form id="addform" class="forms-sample" method="POST"
                                action="{{ route('admin.brand.update', $brand->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    @foreach ($langs as $key => $lang)
                                        <div class="input-field col s12 m6 l6 ">
                                            <input type="text" name="name_{{ $lang['code'] }}"
                                                id="name_{{ $lang['code'] }}"
                                                value="{{ $brand->translateOrDefault($lang['code'])->name }}"
                                    ...
                                    @endforeach
                                    <div class="col s12">
                                        <label for="Image">Image <small>(400 X 200)</small></label>
                                        <div class="s12 input-field">
                                            <input type="file" name="image" id="input-file-events" class="dropify-event"
                                                data-default-file="{{ asset('storage') . '/' . $brand->image }}"
                                                accept="image/*" />
                                        </div>
                                    </div>
                                    <div class="col s12">
                                        <label for="Header">Banner <small>(1920 x 600)</small></label>
                                        <div class="s12 input-field">
                                            <input type="file" name="header" id="input-file-events" class="dropify-event"
                                                data-default-file="{{ asset('storage') . '/' . $brand->header }}"
                                                accept="image/*" />
                                        </div>
                                    </div>
                                    <div class="col s12">
                                    ...
                                    <div class="col s12">
                                        ...
                                        <div class="s12 input-field">
                                            <div class="switch">
                                                <label>
                                                    Normal
                                                    <input type="checkbox" name="status" id="type" @if ($brand->status == 2) checked @endif
                                    ...
                                    <div id="cred">
                                        <div class="input-field col s12 m12 l12">
                                            <input type="text" name="username" id="username"
                                                value="{{ $brand->username }}" class="validate" />
                                            <label for="username">{{ __('admin-content.username') }}*</label>
                                        </div>
                                        <div class="input-field col s12">
                                            <label for="password">{{ __('admin-content.password') }}</label>
                                            <input class="validate" id="password" type="password" name="password">
                                        </div>
                                        <div class="input-field col s12">
                                            <label
                                                for="password_confirmation">{{ __('admin-content.confirm-password') }}</label>
