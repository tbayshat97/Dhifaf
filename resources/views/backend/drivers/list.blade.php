                                ...
                                <table id="page-length-option" class="display">
                                    ...
                                    <tbody>
                                        @foreach ($drivers as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td><img src="{{ asset(isset($item->profile->image) ? 'storage/' . $item->profile->image : 'images/placeholders/user.png') }}"
                                                 width="40" height="40" class="circle" /> </td>
                                                ...
                                                <td>
                                                    <span>{{$item->profile->email ?? null}}</span>
                                                </td>
                                                <td class="center-align">
                                                    <a href="{{ route('admin.driver.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                    <a href="#modalDelete"
                                                        onclick="setRoute('{{ $item }}', '{{ route('admin.driver.destroy', $item) }}')"
