                                ...
                                <table id="page-length-option" class="display">
                                    ...
                                    <tbody>
                                        @foreach ($faqs as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td> {{ $item->translateOrDefault()->question }} </td>
                                                <td> {{ $item->translateOrDefault()->answer }} </td>
                                                <td class="center-align">
                                                    <a href="{{ route('admin.faq.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                    <a href="#modalDelete"
                                                        onclick="setRoute('{{ $item }}', '{{ route('admin.faq.destroy', $item) }}')"
