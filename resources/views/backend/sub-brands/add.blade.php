                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form class="formValidate0" id="formValidate0" method="POST"
                            action="{{ route('admin.sub-brand.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="input-field col s12">
                                        {!! Form::select('parent_id', $brands,  null, ['placeholder'=> 'Select a Parent', 'id' => 'parent'] ) !!}
