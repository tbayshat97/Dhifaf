                ...
                <div class="card-content">
                    <div id="html-view-validations">
                        <form class="formValidate0" id="formValidate0" method="POST"
                            action="{{ route('admin.import-products.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col s12">
                                    <label for="Header">Excel File</label>
                                    <div class="s12 input-field">
                                        <input type="file" name="excel-file" id="input-file-events" class="dropify-event"
                                            data-default-file="" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required />
                                    </div>
                                </div>
