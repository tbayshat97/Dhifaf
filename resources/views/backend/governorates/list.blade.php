                                ...
                                <table id="page-length-option" class="display">
                                    ...
                                    <tbody>
                                        @foreach ($governorates as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td> {{ $item->translateOrDefault()->title ?? null}} </td>
                                                <td class="center-align">
                                                    <a href="{{ route('admin.governorate.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                    <a href="#modalDelete"
                                                        onclick="setRoute('{{ $item }}', '{{ route('admin.governorate.destroy', $item) }}')"
