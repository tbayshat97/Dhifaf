...
@section('content')
                                ...
                                <table id="page-length-option" class="display">
                                    ...
                                    <tbody id="simpleList">
                                        ...
                                        <td class="center-align">
                                            <a href="{{ route('admin.subCategory.show', $item) }}"
                                                class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                            <a href="#modalDelete"
                                                onclick="setRoute('{{ $item->id }}', '{{ route('admin.subCategory.destroy', $item) }}')"
    ...
    <div id="modalDelete" class="modal">
        <div class="modal-content">
            <h4>{{ __('admin-content.delete-subCategory') }}</h4>
            <p>{{ __('admin-content.are-you-sure-you-need-to-delete-this') }} {{ __('admin-content.subCategory') }}?
            </p>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#save_order').click(function(e) {
                ...
                var newForm = $('<form>', {
                        'action': "{{ route('admin.subCategory.order.save') }}",
                        'method': 'POST'
                    })
                    .append($('<input>', {
                        'name': 'orders',
