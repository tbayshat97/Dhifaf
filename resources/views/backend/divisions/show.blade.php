                                ...
                                <div class="row">
                                    @foreach ($langs as $key => $lang)
                                        <div class="input-field col s12 m6 l6 ">
                                            <input type="text" name="name_{{ $lang['code'] }}"
                                                id="name_{{ $lang['code'] }}"
                                                value="{{ $division->translateOrDefault($lang['code'])->name }}"
                                    ...
                                    <div class="col s12">
                                        <label
                                            ...
                                            ({{ $lang['name'] }})</label>
                                        <textarea name="description_{{ $lang['code'] }}" class="materialize-textarea">{{ $division->translateOrDefault($lang['code'])->description }}</textarea>
                                    </div>
                                    @endforeach

                                    <div class="col s12">
                                        <label for="Image">Image <small>(1024 x 1024)</small></label>
                                        <div class="s12 input-field">
                                            <input type="file" name="image" id="input-file-events" class="dropify-event"
                                                data-default-file="{{ asset('storage') . '/' . $division->image }}"
                                                accept="image/*" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col s12">
                                        ...
                                        <div class="s12 input-field">
                                            <input type="file" name="header" id="input-file-events" class="dropify-event"
                                                data-default-file="{{ asset('storage') . '/' . $division->header }}"
                                                accept="image/*"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col s12">
                                        ...
                                        <div class="s12 input-field">
                                            <div class="switch">
                                                <label>
                                                    Unpublished
                                                    <input type="checkbox" name="is_active" id="status" @if ($division->is_active) checked @endif>
