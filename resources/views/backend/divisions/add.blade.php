                    ...
                    <div class="card-content">
                        ...
                        <div id="html-view-validations">
                            <form class="formValidate0" id="formValidate0" method="POST"
                                action="{{ route('admin.division.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    @foreach ($langs as $key => $lang)
                                    <div class="input-field col s12 m6 l6">
                                        <label for="description_{{ $lang['code'] }}">{{ __('admin-content.description') }} ({{ $lang['name'] }})</label>
                                        <textarea name="description_{{ $lang['code'] }}" id="description_{{ $lang['code'] }}" class="materialize-textarea"></textarea>
                                    </div>
                                    @endforeach
