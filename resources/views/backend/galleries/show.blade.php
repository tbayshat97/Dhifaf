                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form class="formValidate0" id="formValidate0" method="POST"
                            action="{{ route('admin.gallery.update', $gallery) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6 ">
                                    <input type="text" name="title_{{ $lang['code'] }}" id="title_{{ $lang['code'] }}"
                                        value="{{ $gallery->translateOrDefault($lang['code'])->title }}" class="validate"
                                        required />
                                        ...
                                        <div class="jFiler-input-inner">
                                            ...
                                            <div class="filediv">
                                                <input type="file" name="image"
                                                    data-fileuploader-files="{{getFileUploaderMedia($gallery->image) }}"
                                                    class="file" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="jFiler-input-inner">
                                            ...
                                            <div class="filediv">
                                                <input type="file" name="gallery_image[]"
                                                    data-fileuploader-files="{{getFileUploaderMedia($gallery->album->gallery_image) }}"
                                                    class="file" multiple="" />
                                            </div>
                                        </div>
                                    </div>
