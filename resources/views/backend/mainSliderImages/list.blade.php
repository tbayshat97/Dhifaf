                        ...
                        <div class="row">
                            <div class="col s12">
                                <table id="page-length-option" class="display">
                                    ...
                                    <tbody>
                                        @foreach ($mainSliderImage as $key => $item)
                                            <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td><img src="{{ asset(isset($item->image) ? 'storage/' . $item->image : 'images/placeholders/user.png') }}"
                                           ...
                                           <td>
                                            ...
                                            <td class="center-align">
                                                <a href="{{ route('admin.main-slider-image.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                <a href="#modalDelete"
                                                onclick="setRoute('{{ $item }}', '{{ route('admin.main-slider-image.destroy', $item) }}')"
