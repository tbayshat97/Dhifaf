                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form id="addform" class="forms-sample" method="POST"
                            action="{{ route('admin.banner.update', $banner) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6 ">
                                    ...
                                    value="{{$banner->translateOrDefault($lang['code'])->name}}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" name="cta" value="{{ $banner->cta }}"  class="validate" required/>
                                    <label for="cta">{{ __('CTA') }}*</label>
                                </div>
                                <div class="col s12">
                                    <label for="Image">Image</label>
                                    <div class="s12 input-field">
                                        <input type="file" name="image" id="input-file-events" class="dropify-event"
                                            data-default-file="{{ asset('storage') . '/' .$banner->image }}"
                                            accept="image/*" />
                                    </div>
                                </div>
                                <div class="input-field col s12">
