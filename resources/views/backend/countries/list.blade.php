                                        ...
                                        @foreach ($country as $key => $item)
                                            <tr>
                                                ...
                                                <td class="center-align">
                                                    <a href="{{ route('admin.country.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                    <a href="#modalDelete"
                                                        onclick="setRoute('{{ $item }}', '{{ route('admin.country.destroy', $item) }}')"
