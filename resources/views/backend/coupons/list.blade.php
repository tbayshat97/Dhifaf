                                ...
                                <table id="page-length-option" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Type')}}</th>
                                            <th>{{ __('Value')}}</th>
                                            <th>{{ __('Usage Limit Per Coupon')}}</th>
                                            <th>{{ __('Usage Limit Per Client')}}</th>
                                    ...
                                    <tbody>
                                        @foreach ($coupon as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="chip lighten-5 green green-text">{{ App\Enums\DiscountType::fromValue($item->type)->description }}</span>
                                                </td>
                                                <td>
                                                    <span>{{$item->value}}</span>
                                                </td>
                                                <td>
                                                    <span>{{$item->ec_per_coupon}}</span>
                                                </td>
                                                <td>
                                                    <span>{{$item->ec_per_customer}}</span>
                                                </td>
                                                <td>
