        ...
        var table = $('#products-datatable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (row.is_variant) {
                            return `<span class="task-cat cyan">Variant</span>`;
                        } else {
...

                {
                    ...
                    render: function(data, type, row) {
                        if (row.qty > 0) {
                            if (row.qty >= row.minQty) {
                                if (row.stock_status) {
                                    return `<span class="task-cat green">In Stock</span>`;
                                } else {
                                    return `<span class="task-cat red">Out of Stock</span>`;
                                }
                            } else {
                                return `<span class="task-cat red">Out of Stock</span>`;
                            }
