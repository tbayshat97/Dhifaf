...
{{-- page title --}}
@section('title', 'Up selling '.__('admin-content.products'))
            ...
            <div class="col s12 m12 l12">
                <div id="button-trigger" class="card card card-default scrollspy">
                    <div class="card-content">
                        <h4 class="card-title">Add up selling product</h4>
                        <div id="html-view-validations">
                            <form class="formValidate0" id="formValidate0" method="post"
                                action="{{ route('admin.up-sale-product.update', $product->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="input-field col s6">
                                        <select name="up" id="up" required class="select2-size-sm browser-default">
                                        </select>
                                    </div>
                                        ...
                                        @foreach ($products as $key => $item)
                                            ...
                                            <td class="
                                                    ...
                                                    <a href="#modalDelete" data-position="bottom" data-delay="50"
                                                        data-tooltip="Delete"
                                                        onclick="setRoute('{{ $item->id }}', '{{ route('admin.up-sale-product.destroy', $item) }}')"
...
@section('page-script')
    ...
    <script>
        $(document).ready(function () {
            var id =  "{{ $product->id }}"
            var url = "{{ route('admin.up-sale-product.ajax.show', ':id') }}";
