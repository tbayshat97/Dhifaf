                        ...
                        <div id="html-view-validations">
                            <form id="addform" class="forms-sample" method="POST"
                                ...
                                <div class="row">
                                    @foreach ($langs as $key => $lang)
                                        <div class="input-field col s12 m6 l6 ">
                                            <input type="text" name="name_{{ $lang['code'] }}"
                                                id="name_{{ $lang['code'] }}"
                                                value="{{ $category->translateOrDefault($lang['code'])->name }}"
                                    ...
                                    @endforeach
                                    <div class="col s12">
                                        <label for="Image">Image <small>(512 x 512)</small></label>
                                        <div class="s12 input-field">
                                            <input type="file" name="image" id="input-file-events" class="dropify-event"
                                                data-default-file="{{ asset('storage') . '/' . $category->image }}"
                                                accept="image/*" />
                                        </div>
                                    </div>
                                    <div class="col s12">
                                        ...
                                        <div class="s12 input-field">
                                            <input type="file" name="header" id="input-file-events" class="dropify-event"
                                                data-default-file="{{ asset('storage') . '/' . $category->header }}"
                                                accept="image/*" />
                                        </div>
                                    </div>

                                    <div class="input-field col s12 m6 l6">
                                        {!! Form::select('divisions[]', $divisions, $selectedDivisions, ['multiple' => true, 'id' => 'divisions']) !!}
                                        <label>{{ __('Divisions') }}</label>
                                    </div>
                                    ...
                                    <div class="col s12 m6 l6">
                                        ...
                                        <div class="s12 input-field">
                                            <div class="switch">
                                                <label>
                                                    Unpublished
                                                    <input type="checkbox" name="is_active" id="status"
