                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form id="addform" class="forms-sample" method="POST"
                            action="{{ route('admin.area.update', $area) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6 ">
                                    ...
                                    value="{{$area->translateOrDefault($lang['code'])->name}}"
                                ...
                                <div class="input-field col s12">
                                    <label for="curl0">Delivery Fees</label>
                                    <input type="number" step="0.5" class="validate"
                                        name="delivery_fees" value="{{ $area->delivery_fees }}">
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
                                        {!! Form::select('city_id', $cities, $area->city_id ?? null, ['placeholder' => 'All Cities', 'id' => 'city_id'])
                                        !!}
                                        <label>{{ __('City') }}<span class="text-red"></span></label>
                                    </div>
                                </div>
                                <div class="input-field col s12">
