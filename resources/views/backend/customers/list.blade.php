                                        ...
                                        @foreach ($customers as $key => $item)
                                            <tr>
                                                ...
                                                <td class="center-align">
                                                    <a href="{{ route('admin.customer.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons dp48">visibility</i><span>visibility</span></a>
                                                    <a href="{{ route('admin.customer.edit', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
