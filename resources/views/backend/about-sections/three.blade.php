...
{{-- page title --}}
@section('title','About Section Three')
{{-- vendor style --}}
            ...
            <div class="card-content">
                <div class="card-title">
                    <div class="row">
                        <div class="col s12 m6 l10">
                            <h4 class="card-title">About Section Three</h4>
                        </div>
                ...
                <div id="html-view-validations">
                    <form id="addform" class="formValidate0" method="POST"
                        action="{{ route('admin.about-section-three-update', $aboutSection) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
