<aside
    ...
    <div class="brand-sidebar">
        <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="{{asset('/influencer')}}">
    ...
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out"
        ...
        @if(!empty($menuDataInfluencer[0]) && isset($menuDataInfluencer[0]))
        @foreach ($menuDataInfluencer[0]->menu as $menu)
        ...
        <li class="bold {{(request()->is($menu->url.'*')) ? 'active' : '' }}">
            ...
            @include('panels-influencer.submenu', ['menu' => $menu->submenu])
            @endif
        </li>
        @endif
        @endforeach
