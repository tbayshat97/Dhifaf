    ...
    <nav class="white hide-on-med-and-down" id="horizontal-nav">
        <div class="nav-wrapper">
            <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation">
                ...
                @if(!empty($menuDataInfluencer[1]) && isset($menuDataInfluencer[1]))
                @foreach ($menuDataInfluencer[1]->menu as $menu)
                @php
                $custom_classes="";
                if(isset($menu->class))
                {
                ...
                @endphp
                <li>
                    <a @if(isset($menu->submenu)){{'class=dropdown-menu'}} @endif href="{{$menu->url}}"
                        data-target="{{$menu->activate}}">
                    ...
                    @include('panels-influencer.horizontalSubmenu',['menu' => $menu->submenu],['activate'=>$menu->activate])
                    @endif
                </li>
                @endforeach
                @endif
