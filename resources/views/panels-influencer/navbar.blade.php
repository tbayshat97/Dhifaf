    ...
    <nav
        ...
        <div class="nav-wrapper">
            <div class="header-search-wrapper hide-on-med-and-down">
                ...
                <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Explore Admin Panel"
                ...
                <li>
                    <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                        ...
                        <span class="avatar-status avatar-online">
                            @php
                            $accountImage = auth('influencer')->user()->profile->getProfileImage() ? asset(auth('influencer')->user()->profile->getProfileImage()) :
                            asset('images/placeholders/user.png');
                            @endphp
                            <img src="{{ $accountImage }}" alt="avatar"><i></i>
                        </span>
                    </a>
                </li>
                {{-- <li>
            ...
            <ul class="dropdown-content" id="profile-dropdown">
                <li>
                    <a class="grey-text text-darken-1" href="{{ route('influencer.profile') }}">
                ...
                <li>
                    <a class="grey-text text-darken-1" href="{{ route('influencer.logout') }}">
