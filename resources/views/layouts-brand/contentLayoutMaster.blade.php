...
<head>
    ...
    <title>@yield('title') | brand Panel </title>
    ...
    @include('panels-brand.styles')
</head>

@if(!empty($configData['mainLayoutType']) && isset($configData['mainLayoutType']))
@include(($configData['mainLayoutType'] === 'horizontal-menu') ?
'layouts-brand.horizontalLayoutMaster':'layouts-brand.verticalLayoutMaster')
@else
