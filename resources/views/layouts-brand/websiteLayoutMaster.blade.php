...
-->
        ...
        <head>
            ...
            @include('website.panels-brand.styles')
        </head>
        <!-- END: Head-->
        <body>
            <div id="app">
                @include('website.panels-brand.header')
                <!--  main content -->
                @yield('content')
                @include('website.panels-brand.footer')
                @include('website.panels-brand.bottom-menu')
            </div>
                {{-- vendor scripts and page scripts included --}}
                @include('website.panels-brand.scripts')
        </body>
</html>
