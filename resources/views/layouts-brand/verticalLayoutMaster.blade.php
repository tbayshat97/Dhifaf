<body
  ...
  <header class="page-topbar" id="header">
    @include('panels-brand.navbar')
  </header>
  <!-- END: Header-->

  <!-- BEGIN: SideNav-->
  @include('panels-brand.sidebar')
  <!-- END: SideNav-->
  ...
  <div id="main">
    <div class="row">
      ...
      {{--  breadcrumb --}}
      @include('panels-brand.breadcrumb')
      @endif
      <div class="col s12">
        <div class="container">
             @include('panels-brand.message')
          {{-- main page content --}}
          @yield('content')
          {{-- right sidebar --}}
  ...
  {{-- footer  --}}
  @include('panels-brand.footer')
  {{-- vendor and page scripts --}}
  @include('panels-brand.scripts')
</body>
