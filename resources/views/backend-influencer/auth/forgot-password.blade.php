...
<div id="forgot-password" class="row">
    <div class="col s12 m6 l4 z-depth-4 offset-m4 card-panel border-radius-6 forgot-card bg-opacity-8">
        <form class="login-form" action="{{ route('influencer.forget.password.post') }}" method="POST">
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s6 m6 l6">
                    <p class="margin medium-small"><a href="{{ route('influencer.login_form') }}">Login</a></p>
                </div>
            </div>
        </form>
    </div>
