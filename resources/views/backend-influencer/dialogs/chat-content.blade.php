...
<div class="chat-header animate fadeUp">
    <div class="row valign-wrapper">
        ...
        <div class="col">
            <p class="m-0 blue-grey-text text-darken-4 font-weight-700">{{ 'dhifaf-baghdad' }}</p>
            <p class="m-0 chat-text truncate">{{ 'Admin' }}</p>
        </div>
    </div>
...
<div class="chat-area animate fadeUp" style="overflow-y: visible; overflow-x: hidden;">
    <div class="chats" id="activeChatArea{{ $dialog->id }}">
        ...
        @if ($item->from_accountable_type === App\Models\Influencer::class)
