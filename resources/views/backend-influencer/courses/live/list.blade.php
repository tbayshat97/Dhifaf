                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center-align">
                                            <a href="{{ route('influencer.course.live.show', $item->live->id) }}"
                                            class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                            <a href="#modalDelete"
                                            onclick="setRoute('{{ $item->live->id }}', '{{ route('influencer.course.live.delete', $item->live->id) }}')"
                                            class="modal-trigger btn-floating red pulse"><i
                                                class="material-icons">delete</i></a>
                                            <a href="{{ $item->live->start_url }}"
                                            class="btn-floating tooltipped  cyan green pulse" target="_blank" data-position="top" data-tooltip="Start"><i class="material-icons">videocam</i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
